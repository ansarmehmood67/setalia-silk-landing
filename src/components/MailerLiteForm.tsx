...
const MailerLiteForm = () => {
  return (
    <div className="mailerlite-form-wrapper w-full">
      <div
        dangerouslySetInnerHTML={{
          __html: `
    <div id="mlb2-31564657" class="ml-form-embedContainer ml-subscribe-form ml-subscribe-form-31564657">
      <div class="ml-form-align-center">
        <div class="ml-form-embedWrapper embedForm">
          <div class="ml-form-embedBody ml-form-embedBodyHorizontal row-form">
            <div class="ml-form-embedContent" style="margin-bottom: 0px;"></div>
            <form class="ml-block-form" action="https://assets.mailerlite.com/jsonp/851102/forms/167077809411327475/subscribe" data-code="" method="post" target="_blank">
